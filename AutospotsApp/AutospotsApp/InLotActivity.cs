...
namespace AutospotsApp
{
    ...
    public class InLotActivity : Activity
    {
        ...
        private void SendSpotRequest(int lotIndex)
        {
            ...
            clientSend("BUILDING_" + lotIndex);
            System.Threading.ThreadPool.QueueUserWorkItem(o => clientReceive()); //Starts Receiving When Connected
        }
        ...
        private void clientReceive()
        {
            try
            {
                ...
                if (stream.CanRead)
                {
                    ...
                    Android.Util.Log.Debug(TAG, "Received \'" + returndata + "\' from server!");
